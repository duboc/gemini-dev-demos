...
model_name = st.radio(
      label="Model:",
      options=["gemini-experimental", "gemini-1.5-pro-preview-0409", "gemini-1.5-flash-preview-0514"],
...
prompt = f"""
            ...
            Essa descrição vai ser utilizado para backlog de desenvolvimento para criação de frontend, 
            backend e o plano de deploy no Google CLoud.
...
if generate_gcloud:
    with st.spinner("Generating your Google Cloud scripts Gemini..."):
        ...
        with first_tab1:
            ...
            O output precisa ser modulos ansible da collection do google.cloud dentro das melhores práticas.
            Crie um passo a passo de como fazer o deploy utilizando o ansible: \n
