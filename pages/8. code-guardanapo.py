...
image1 = Part.from_uri(
    mime_type="image/png",
    uri="gs://convento-samples/guardanapo.jpg")
prompt = f""" 
            Explique essa guardanapo no formato de implementação de features para uma história de usuário. A ideia é um site de piadas aleatorias geradas usando vertex ai com o modelo gemini-1.5-flash-001\n
