...
def main(repo_url):
    input_path = repo_url
    output_file = "files/uncompressed_output.txt"
    urls_list_file = "files/processed_urls.txt"
    max_depth = 2
    include_pdfs = True
    ignore_epubs = True
    ...
    processed_file = "files/compressed_output.txt"
    ...
    print(f"compressed_output.txt and uncompressed_output.txt have been created in the files directory. ")
